...
var alexandre = User(name:"Alexandre", gender: "male", image:"myAvatar8",hobbies:"Sport",nbTrips:2,favoriteStations:["Gare du Nord"])
var karla = User(name:"Karla", gender: "female", image:"myAvatar2",hobbies:"Lecture",nbTrips:1,favoriteStations:["St Lazare"])
